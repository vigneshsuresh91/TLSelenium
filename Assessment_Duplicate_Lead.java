...
public class Assessment_Duplicate_Lead {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.name("description")).sendKeys("Entering the Text Post Clearing the Initial Value");
		driver.findElement(By.name("importantNote")).sendKeys("Important Points Noted");
